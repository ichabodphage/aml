...
namespace aml
{
    ...
    std::vector<aml::Vector3float> cubeVertices = {
        aml::Vector3float(-0.5f, 0.5f, 0.5f),
        aml::Vector3float(0.5f, 0.5f, 0.5f),
        aml::Vector3float(0.5f, -0.5f, 0.5f),
        aml::Vector3float(0.5f, -0.5f, 0.5f),
        aml::Vector3float(-0.5f, -0.5f, 0.5f),
    ...
    std::vector<aml::Vector3float> cubeColors = {
        aml::Vector3float(1.0f, 0.0f, 0.0f),
        aml::Vector3float(0.0f, 1.0f, 0.0f),
        aml::Vector3float(0.0f, 0.0f, 1.0f),
        aml::Vector3float(0.0f, 0.0f, 1.0f),
        aml::Vector3float(1.0f, 1.0f, 0.0f),
        aml::Vector3float(1.0f, 0.0f, 0.0f),
